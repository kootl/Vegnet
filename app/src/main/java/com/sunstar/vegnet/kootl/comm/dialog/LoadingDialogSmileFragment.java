 ...
 */
public class LoadingDialogSmileFragment extends AppCompatDialogFragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.dialog_loading_smile, null);
    ...
    public static LoadingDialogSmileFragment newInstance(String message) {
        LoadingDialogSmileFragment dialogFragment = new LoadingDialogSmileFragment();
