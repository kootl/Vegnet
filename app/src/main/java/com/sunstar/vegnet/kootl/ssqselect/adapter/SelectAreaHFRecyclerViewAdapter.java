 ...
 */
public class SelectAreaHFRecyclerViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public SelectAreaHFRecyclerViewAdapter(List<AreaSelectBean> selectAreaBeanList) {
        mSelectAreaBeanList = selectAreaBeanList;
    }

    List<AreaSelectBean> mSelectAreaBeanList;

    @Override
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_list_area, parent, false);
